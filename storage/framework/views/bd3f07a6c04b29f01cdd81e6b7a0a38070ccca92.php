...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('vsG8G1Y')) {
    $componentId = $_instance->getRenderedChildComponentId('vsG8G1Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('vsG8G1Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vsG8G1Y');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('vsG8G1Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/front-end/sellers/search-sellers.blade.php ENDPATH**/ ?>