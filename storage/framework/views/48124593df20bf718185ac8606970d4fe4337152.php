...
<?php $__env->startSection('template_title'); ?>
    <?php echo e(__('installer_messages.permissions.templateTitle')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('title'); ?>
    <i class="fa fa-key fa-fw" aria-hidden="true"></i>
    <?php echo e(__('installer_messages.permissions.title')); ?>
    ...
    <?php if( ! isset($permissions['errors'])): ?>
        <div class="buttons">
            <a href="<?php echo e(route('LaravelInstaller::environment')); ?>" class="button">
                <?php echo e(__('installer_messages.permissions.next')); ?>
